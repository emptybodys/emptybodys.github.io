...
<div>
    ...
    <br>
    <audio src="/media/real/bird/1.wav" controls="controls"></audio><audio src="/media/real/bird/2.wav" controls="controls"></audio><audio src="/media/real/bird/3.wav" controls="controls"></audio>
</div>
